...
abstract class NextBaseTele(val isBlue: Boolean, val isCalibration: Boolean = false) : NextFTCOpMode() {
...
//                Fries.fireAllSorted(false).schedule()
    ...
    override fun onUpdate() {
        ...
        ActiveOpMode.telemetry.addData("X", pose.x)
        ActiveOpMode.telemetry.addData("Y", pose.y)
        ActiveOpMode.telemetry.addData("Yaw", Math.toDegrees(pose.heading))
